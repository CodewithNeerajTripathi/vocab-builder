...
1: [
   ...
   { word: "cautious",    pos: "adjective",    meaning: "careful to avoid danger or mistakes",                              example: "The students were {word} as they walked on the wet floor of the school corridor.", examples: ["Since the floor was wet, the students were {word} as they walked.", "Ever since his fall, Surya has been {word} while climbing the stairs.", "Be {word} while crossing the road in heavy traffic.", "It is wise to be {word} when trying something unfamiliar.", "We need to be more {word} when no one is home."] },
    ...
    { word: "permission",  pos: "noun",         meaning: "approval to do something",                                         example: "Will you ask for {word} to leave early?", examples: ["Will you take {word} to leave early?", "The children got {word} to use the art room after school.", "We should never take something without {word}.", "You must ask for {word} before leaving the classroom.", "Dad said, 'Ask Mom's {word} before you go to your friend's house.'"] },
...
2: [
 ...
 { word: "mark", pos: "noun / verb", meaning: "a score; to show or label", example: "He got good {word}s in science.(noun)", examples: ["He got good {word} in science.(noun)", "Please {word} the correct option.(verb)", "The {word} is visible on the page.(noun)", "The teacher {word}ed the answers yesterday.(verb)", "Did the Art teacher {word} your work?(verb)"] },
  ...
  { word: "relevant", pos: "adjective", meaning: "closely connected to the topic", example: "Your points are {word} to the topic.", examples: ["Your points are {word} to the topic.", "Her example was {word} yesterday.", "{Word} details make answers stronger.", "Add only {word} information.", "I don't think Gia's example is {word}."] },
   ...
   { word: "justify", pos: "verb", meaning: "give reasons for something", example: "Please {word} your answer.", examples: ["Please {word} your answer.", "He <strong style=\"color:#0656be;font-weight:900;\">justified</strong> his idea yesterday.", "Jaya is {word}ing her choice with examples.", "You will {word} your reasoning in writing.", "No reason can {word} the inequality women face in society."] },
    { word: "summarise", pos: "verb", meaning: "give main points briefly", example: "Please {word} the lesson.", examples: ["Please {word} the lesson.", "She {word}d the story yesterday.", "The group will {word} the article in their presentation.", "The teacher said, 'We will {word} the chapter tomorrow.'", "I have to {word} ten chapters and submit them to the teacher by Wednesday."] },
  ...
  { word: "modify", pos: "verb", meaning: "to change slightly", example: "The teacher allowed me to {word} some of my answers and resubmit the homework.", examples: ["The teacher allowed me to {word} some of my answers and resubmit the homework.", "Our travel plan had to be <strong style=\"color:#0656be;font-weight:900;\">modified</strong> at the last minute.", "We will {word} the solar engine model for the next science fair.", "The team will {word} the work, if needed.", "Can you {word} this sentence?"] },
    ...
    { word: "result", pos: "noun", meaning: "outcome", example: "On Wednesday, Rohan was waiting nervously for the {word}.", examples: ["On Wednesday, Rohan was waiting nervously for the {word}.", "After weeks of practice, Meera was happy with the {word} of her hard work.", "The class worked together. The {word} was a beautiful wall magazine.", "Aarav forgot to water the plant. The {word} was that it dried up.", "The final {word} of the basketball match was in our school's favour."] },
...
4: [
 ...
 { word: "verify", pos: "verb", meaning: "to check if something is true or correct", example: "Always {word} your answer by checking your steps again.", examples: ["Always {word} your answer by checking your steps again.", "The students <strong style=\"color:#0656be;font-weight:900;\">verified</strong> the experiment results before writing their conclusions.", "Please {word} the information before sharing it with the class.", "Rohan <strong style=\"color:#0656be;font-weight:900;\">verified</strong> the spelling using a dictionary.", "Why is it important to {word} facts before believing them?"] },
 ...
 { word: "sceptical", pos: "adjective", meaning: "not easily convinced; questioning", example: "Being {word} helped her avoid trusting fake information online.", examples: ["Being {word} helped her avoid trusting fake information online.", "Meera felt {word} until she saw the proof.", "A {word} reader asks questions while reading.", "He gave a {word} look when his friend made a surprising claim.", "Why should we be {word} of rumours?"] },
   ...
   { word: "strategically", pos: "adverb", meaning: "in a planned and thoughtful way", example: "The shop arranged its items {word} to attract more customers.", examples: ["The shop arranged its items {word} to attract more customers.", "Place your moves {word} in a game of chess.", "The new football team played {word} and won the match.", "Planning {word} helps avoid mistakes.", "How can you prepare {word} for exams?"] },
    ...
    { word: "report", pos: "noun / verb", meaning: "to give information clearly", example: "A good {word} includes facts and observations. (noun)", examples: ["A good {word} includes facts and observations. (noun)", "The student will {word} the incident to the teacher. (verb)", "The weather {word} was shown on television. (noun)", "Please {word} your findings to the class. (verb)", "The students wrote a {word} on their science experiment. (noun)"] },
...
3: [
  ...
  5: [
    ...
    { question: "What does the word 'kindergarten' mean?", options: ["a play area", "a garden", "early childhood school", "a toy store"], answer: "early childhood school" },
...
options.forEach(opt => {
  ...
  const prevResult = mcqResults[mcqIndex];
  if (prevResult) {
    mcqAnswered = true;
    const allBtns = container.querySelectorAll('.mcq-opt-btn');
    allBtns.forEach(b => { b.disabled = true; });
    const selectedBtn = Array.from(allBtns).find(b => b.textContent === prevResult.userAnswer);
    if (prevResult.isCorrect) {
      if (selectedBtn) {
        selectedBtn.classList.add('clicked-selected', 'correct');
        const check = document.createElement('span');
        check.className = 'mcq-check';
        check.textContent = '✓';
        selectedBtn.parentElement.appendChild(check);
      }
      ...
      if (selectedBtn) {
        selectedBtn.classList.add('clicked-selected', 'wrong');
        const wrongCheck = document.createElement('span');
        wrongCheck.className = 'mcq-check mcq-wrong-check';
        wrongCheck.textContent = '✗';
        selectedBtn.parentElement.appendChild(wrongCheck);
      }
      allBtns.forEach(b => {
        if (b.textContent === prevResult.correct) {
      ...
      document.querySelector('#mcq-wrong-feedback .wrong-text').textContent = 'So Close!';
